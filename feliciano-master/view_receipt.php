...
<div class="max-w-[400px] mx-auto mt-8 flex flex-col sm:flex-row gap-4 no-print">
    ...
    <button id="downloadPdf"
            class="bg-gradient-to-r from-yellow-300 to-amber-300 text-pink-900 px-6 py-4 rounded-2xl font-bold shadow-lg hover:shadow-xl transition flex-1 text-lg flex items-center justify-center gap-2">
        ⬇️ Download PDF 
    </button>
</div>
